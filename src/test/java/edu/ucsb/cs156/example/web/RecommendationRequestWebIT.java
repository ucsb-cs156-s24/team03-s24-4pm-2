...
public class RecommendationRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_recommendationRequest() throws Exception {
        ...
        page.getByTestId("RecommendationRequestForm-requesterEmail").fill("kaimaeda@ucsb.edu");
        ...
        page.getByTestId("RecommendationRequestForm-dateRequested").pressSequentially("02020020240320PM");
        page.getByTestId("RecommendationRequestForm-dateNeeded").pressSequentially("02020020240320PM");
        ...
        page.getByTestId("RecommendationRequestForm-professorEmail").fill("phtcon2@ucsb.edu");
        page.getByTestId("RecommendationRequestForm-submit").click();

        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-professorEmail"))
                .hasText("phtcon2@ucsb.edu");
