...
public class UCSBOrganizationWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_organization() throws Exception {
        ...
        page.getByTestId("UCSBOrganizationForm-submit").click();
        assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslationShort")).hasText("Test");
        assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslation")).hasText("ZETA");
