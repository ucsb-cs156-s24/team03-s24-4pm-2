...
public class ArticleWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_article() throws Exception {
        ...
        page.getByTestId("ArticlesForm-title").fill("Cookie");
        page.getByTestId("ArticlesForm-url").fill("www.cookie.com");
        page.getByTestId("ArticlesForm-explanation").fill("A delicious treat");
        page.getByTestId("ArticlesForm-email").fill("cookie@gmail.com");
        page.getByTestId("ArticlesForm-dateAdded").pressSequentially("02020020240320PM");
        page.getByTestId("ArticlesForm-submit").click();

        assertThat(page.getByTestId("ArticlesTable-cell-row-0-col-explanation"))
                .hasText("A delicious treat");

        page.getByTestId("ArticlesTable-cell-row-0-col-Edit-button").click();
        assertThat(page.getByText("Edit Article")).isVisible();
        page.getByTestId("ArticlesForm-explanation").fill("THE BEST COOKIE");
        page.getByTestId("ArticlesForm-submit").click();

        assertThat(page.getByTestId("ArticlesTable-cell-row-0-col-explanation")).hasText("THE BEST COOKIE");
