...
public class RecommendationRequestControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_recommendationrequest() throws Exception {
                ...
                LocalDateTime ldt4 = LocalDateTime.parse("2023-03-11T00:00:00");
                ...
                expectedDates.addAll(Arrays.asList(recommendationRequest1,
                                recommendationRequest2));
        ...
        public void an_admin_user_can_post_a_new_RecommendationRequest() throws Exception {
                ...
                verify(recommendationRequestRepository,
                                times(1)).save(recommendationRequest1);
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_does_not_exist() throws Exception {
                ...
                assertEquals("RecommendationRequest with id 7 not found",
                                json.get("message"));
        }
        ...
        public void admin_can_delete_a_request() throws Exception {
                ...
                Map<String, Object> json = responseToJson(response);
                assertEquals("Recommendation request with id 15 deleted",
                                json.get("message"));
        }
        ...
        public void admin_tries_to_delete_non_existant_recommendationrequest_and_gets_right_error_message()
                ...
                verify(recommendationRequestRepository, times(1)).findById(15L);
                Map<String, Object> json = responseToJson(response);
                assertEquals("RecommendationRequest with id 15 not found",
                                json.get("message"));
        }
        ...
        public void admin_can_edit_an_existing_recommendationrequest() throws Exception {
                ...
                RecommendationRequest recommendationRequestEdited = RecommendationRequest.builder()
                                .requesterEmail("cgaucho25@ucsb.edu")
                                .professorEmail("phtconasf@ucsb.edu")
                                .explanation("BS/MasdfS")
                                .dateRequested(ldt2)
                                .dateNeeded(ldt1)
                                .done(false)
                                .build();
                ...
                verify(recommendationRequestRepository,
                                times(1)).save(recommendationRequestEdited); // should be
                // savedwith
                // correct user
                String responseString = response.getResponse().getContentAsString();
        ...
        @WithMockUser(roles = { "ADMIN", "USER" })
        @Test
        public void admin_cannot_edit_recommendationrequest_that_does_not_exist()
                        throws Exception {
                // arrange
                ...
                RecommendationRequest recommendationEditedDate = RecommendationRequest.builder()
                                .requesterEmail("cgaucho21@ucsb.edu")
                                .professorEmail("phtcon15@ucsb.edu")
                                .explanation("I don't exist")
                                .dateRequested(ldt1)
                                .dateNeeded(ldt2)
                                .done(false)
                                .build();
                ...
                verify(recommendationRequestRepository, times(1)).findById(67L);
                Map<String, Object> json = responseToJson(response);
                assertEquals("RecommendationRequest with id 67 not found",
                                json.get("message"));
