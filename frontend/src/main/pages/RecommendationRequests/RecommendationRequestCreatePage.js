...
export default function RecommendationRequestsCreatePage({storybook=false}) {
  ...
  const onSuccess = (recommendationRequest) => {
    toast(`New recommendationRequest Created - id: ${recommendationRequest.id} Requester Email: ${recommendationRequest.requesterEmail} Professor Email ${recommendationRequest.professorEmail}`);
  }
